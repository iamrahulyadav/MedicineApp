...
public class MyFamilyFragment extends Fragment implements View.OnClickListener {
    ...
    private ArrayList<FamilyModel> list = new ArrayList<FamilyModel>();
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                            FamilyModel data = postSnapshot.getValue(FamilyModel.class);
    ...
    private void setRecyclerView() {
        adapter = new MyFamilyAdapter(context, list);
