...
public class OldLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btnLogin:
                Functions.hideSoftKeyboard(context, view);
                startActivity(new Intent(OldLoginActivity.this, MainActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP));
                break;
            case R.id.btnSignup:
                Functions.hideSoftKeyboard(context, view);
                startActivity(new Intent(OldLoginActivity.this, LoginActivity.class));
                break;
        }
    }
